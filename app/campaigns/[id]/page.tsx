        ...
        <DetailHero
          ...
          actions={
            <>
              <Link
                href="/analytics"
                className="rounded-[14px] border border-white/10 bg-white/[0.04] px-3.5 py-2.5 text-[12px] font-semibold text-text transition hover:border-primary/30 hover:bg-primary/5"
              >
                Open Analytics
              </Link>
              <button
            ...
            <DetailSidebarSurface title="Distribution Engine">
              <div className="mt-4 space-y-4">
                ...
                <button
                  ...
                  className="w-full rounded-[18px] border border-primary/25 bg-primary/[0.055] px-4 py-3 font-bold text-primary transition hover:bg-primary/[0.075]"
                  ...
                  <div
                    className={`rounded-[18px] px-4 py-3 text-sm ${
                      finalizeMessage.tone === "error"
                        ? "border border-rose-500/30 bg-rose-500/[0.055] text-rose-200"
                        : finalizeMessage.tone === "success"
                          ? "border border-primary/30 bg-primary/[0.055] text-primary"
                          : "border border-white/[0.026] bg-white/[0.014] text-sub"
                    }`}
                  >
...
function AnalyticsStat({
  ...
  return (
    <div className="rounded-[18px] border border-white/[0.026] bg-white/[0.016] p-3.5">
