...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg px-6">
      <div className="w-full max-w-md rounded-[20px] border border-white/[0.026] bg-white/[0.014] p-6 shadow-neon">
        <div className="mb-6 flex items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-primary/30 bg-primary/[0.055] text-primary">
            <ShieldCheck size={26} />
          </div>
          <div>
        ...
        {mfaPending ? (
          <form onSubmit={handleVerifyTotp} className="space-y-4">
            <div className="rounded-[18px] border border-primary/20 bg-primary/[0.055] px-4 py-4 text-sm leading-6 text-sub">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-2xl border border-white/[0.026] bg-white/[0.016] px-4 py-3 outline-none transition focus:border-primary/40"
                placeholder="123456"
                required
              />
            </div>
          ...
          <>
            ...
            <div className="mt-5 rounded-[18px] border border-white/10 bg-white/[0.014] p-4">
