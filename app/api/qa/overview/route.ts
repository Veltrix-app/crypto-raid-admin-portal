...
import { loadQaOverview } from "@/lib/release/release-overview";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const overview = await loadQaOverview();
    ...
    const message = error instanceof Error ? error.message : "Failed to load QA overview.";
    const status =
