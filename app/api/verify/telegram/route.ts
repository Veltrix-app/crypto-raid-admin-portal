...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (
      resolvedIntegration.questType !== "telegram_join" ||
      resolvedIntegration.verificationProvider !== "telegram" ||
      ...
      return NextResponse.json(
        {
          ...
          error: "This project still needs an active Telegram integration before membership checks can run.",
        },
        { status: 400 }
      );
    }
