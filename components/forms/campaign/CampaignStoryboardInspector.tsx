    ...
    <div className="rounded-[18px] border border-white/[0.032] bg-[linear-gradient(180deg,rgba(17,21,31,0.96),rgba(10,12,18,0.94))] p-4 shadow-[0_18px_46px_rgba(0,0,0,0.2)]">
      ...
      <div className="mt-4 space-y-2.5">
        {block.notes.map((note) => (
          <div
            key={note}
            className="rounded-[18px] border border-white/[0.032] bg-white/[0.018] px-3.5 py-3.5"
          >
      ...
      {children ? <div className="mt-5 border-t border-white/[0.032] pt-5">{children}</div> : null}
    </div>
  );
}
