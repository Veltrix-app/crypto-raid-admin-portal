...
export default function StudioModeToggle<TValue extends string>({
  ...
  return (
    <div className="rounded-[18px] border border-white/[0.032] bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.02))] p-2 shadow-[0_16px_34px_rgba(0,0,0,0.18)]">
            ...
            <button
              ...
              className={`rounded-[20px] border px-4 py-4 text-left transition ${
                active
                  ...
                  : "border-white/[0.032] bg-black/20 hover:border-white/14 hover:bg-white/[0.04]"
              }`}
            >
              {option.eyebrow ? (
