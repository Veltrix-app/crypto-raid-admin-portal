...
export default function StudioStepRail<TStep extends string>({
  ...
  return (
    <aside className="rounded-[20px] border border-white/[0.026] bg-[linear-gradient(180deg,rgba(13,17,24,0.96),rgba(9,11,16,0.94))] p-3.5 shadow-[0_12px_28px_rgba(0,0,0,0.16)] xl:sticky xl:top-24 xl:self-start">
              ...
              className={`min-w-[124px] rounded-[16px] border px-3 py-2.5 text-left transition ${
                active
                  ...
                  : step.complete
                    ...
                    : "border-white/[0.026] bg-black/20"
              }`}
            >
              <div className="flex items-center gap-2.5">
                <span
                  className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full border text-[11px] font-black ${
                    active
                      ? "border-primary/25 bg-primary/[0.065] text-primary shadow-[0_0_16px_rgba(199,255,0,0.25)]"
                      : step.complete
                        ? "border-primary/15 bg-primary/[0.055] text-primary"
                        : "border-white/[0.032] bg-white/[0.016] text-sub"
                  }`}
                >
        ...
        {steps.map((step, index) => {
          ...
          const statusTone = active
            ...
            : step.complete
              ...
              : "border-white/[0.026] bg-black/20 hover:border-white/[0.045] hover:bg-white/[0.035]";
              ...
              <div className="flex items-center gap-3">
                <span
                  className={`relative z-[1] flex h-9 w-9 shrink-0 items-center justify-center rounded-full border text-[11px] font-black ${
                    active
                      ? "border-primary/25 bg-primary/[0.065] text-primary shadow-[0_0_16px_rgba(199,255,0,0.28)]"
                      : step.complete
                        ? "border-primary/15 bg-primary/[0.055] text-primary"
                        : "border-white/[0.032] bg-white/[0.016] text-sub"
                  }`}
